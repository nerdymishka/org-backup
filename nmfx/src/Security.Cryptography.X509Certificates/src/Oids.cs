...
namespace NerdyMishka.Security.Cryptography.X509Certificates
{
    ...
    public static class Oids
    {
        ...
        /// <summary>
        /// The Windows TCB Componet oid (1.3.6.1.4.1.311.10.3.23).
        /// </summary>
        ...
        /// <summary>
        /// Tthe Windows Hardware Driver Extended Verification oid (1.3.6.1.4.1.311.10.3.39).
        /// </summary>
        ...
        /// <summary>
        /// The Key Recoverty Agent oid (1.3.6.1.4.1.311.21.6).
        /// </summary>
        public const string KeyRecoveryAgent = "1.3.6.1.4.1.311.21.6";

        /// <summary>
        /// The Key Pack Llicenses oid (1.3.6.1.4.1.311.10.6.1).
        /// </summary>
        public const string KeyPackLicenses = "1.3.6.1.4.1.311.10.6.1";

        /// <summary>
        /// The Early Launch Antimwalware Driver oid (1.3.6.1.4.1.311.61.4.1).
        /// </summary>
        public const string EarlyLaunchAntimalwareDriver = "1.3.6.1.4.1.311.61.4.1";
        ...
        /// <summary>
        /// The IP Security IKE Intermediat oid (1.3.6.1.5.5.8.2.2).
        /// </summary>
        ...
        /// <summary>
        /// The SPC Relazed PE Marker Check oid (1.3.6.1.4.1.311.2.6.1).
        /// </summary>
        ...
        /// <summary>
        /// The Microsoft Publiser oid (1.3.6.1.4.1.311.76.8.1).
        /// </summary>
